...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    # (5) softmax to compute loss using captions_out, ignoring the points where the output word is <NULL> using the mask above
